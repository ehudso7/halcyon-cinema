...
// Close/X icon - for closing modals and panels
...
// Edit/Pencil icon - for editing items
...
// Alert/Warning icon - for duplicate detection
...
// Copy/Duplicate icon - for duplicate detection
...
// Merge icon - for merging duplicates
export function MergeIcon({ size = 24, color = 'currentColor', className = '' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M8 6l4 4 4-4" />
      <path d="M12 2v8" />
