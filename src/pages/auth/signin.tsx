...
export default function SignIn({ providers }: SignInProps) {
  ...
  const hasGoogleProvider = providers && 'google' in providers;
  const hasGithubProvider = providers && 'github' in providers;
  const hasAnyOAuthProvider = hasGoogleProvider || hasGithubProvider;
